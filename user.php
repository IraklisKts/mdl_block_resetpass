        ...
        foreach ($users as $user) {
            ...
            if (has_capability('moodle/user:update', $sitecontext)) {
                ...
                if (is_siteadmin($USER) or !is_siteadmin($user)) {
                    $url = new moodle_url('sendemail.php', array('id' => $user->id));
                    // $buttons[] = html_writer::link($url, $OUTPUT->pix_icon('t/img_reset', 'Reset Password'));
                    $buttons[] = $OUTPUT->single_button($url, 'Reset Password', 'get');
                }
            }
